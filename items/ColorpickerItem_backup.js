...
class ColorItem {
    ...
    getItemColorTemperatureState(callback) {
    ...
    setItemColorTemperatureState(value, callback) {
    ...
    setItemPowerState(value, callback) {
    ...
    setItemHueState(value, callback) {
    ...
    setItemSaturationState(value, callback) {
    ...
    setItemBrightnessState(value, callback) {
        this.brightness = parseInt(value);
        this.power = this.brightness > 0;
        this.setColorState(callback);
    }

    setColorState(callback) {
        //compose hsv string
